...
namespace vr
{
	...
	struct VR_IVROverlay_FnTable
	{
		...
		EVROverlayError (__stdcall *CreateOverlay)( const char *pchOverlayKey, const char *pchOverlayName, VROverlayHandle_t * pOverlayHandle );
	...
	public:
		...
		* If the texture needs to be resolved, you should call SetOverlayTexture with the appropriate colorspace instead. */
		...
		uint32_t GetOverlayRenderModel( vr::VROverlayHandle_t ulOverlayHandle, char *pchValue, uint32_t unBufferSize, HmdColor_t *pColor, vr::EVROverlayError *pError ) { return _table.GetOverlayRenderModel(ulOverlayHandle, pchValue, unBufferSize, pColor, pError); }
	...
	static const char * const IVROverlay_Version = "FnTable:IVROverlay_016";
